...
class App(QMainWindow):
    ...
    def initUI(self):
        ...
        self.yText.setFont(QFont('Calibri', 14))
        ...
        #self.show()
        self.calculateButton.setStyleSheet("background-color : teal")
        ...
        self.elementButton.setStyleSheet("background-color : teal")
        ...
        self.clearButton.setStyleSheet("background-color : teal")
